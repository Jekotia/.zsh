# Generated by Powerlevel10k configuration wizard on 2020-04-29 at 11:26 EDT.
...
# sharp tails, 2 lines, solid, full frame, lightest-ornaments, compact, fluent,
...
() {
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_IP_VISUAL_IDENTIFIER_EXPANSION='󰈁'
